...
public interface IExample
{
	...
	public Reaction insert(
			final @CookieParam(value = "token") @WebParam(name = "token") String token,
			final @PathParam(value = "exampleId") @WebParam(name = "exampleId") String exampleId,
			final @PathParam(value = "stepIdA") @WebParam(name = "stepIdA") String stepIdA,
			final @PathParam(value = "stepIdB") @WebParam(name = "stepIdB") String stepIdB)
					 throws Problem;
	

	@POST @Path("remove/{exampleId}/{stepId}")
	@WSDLDocumentation("Remove a step in the given example. The step must not be the last step unless it is the terminal step.")
	public Reaction remove(
			final @CookieParam(value = "token") @WebParam(name = "token") String token,
			final @PathParam(value = "exampleId") @WebParam(name = "exampleId") String exampleId,
			final @PathParam(value = "stepId") @WebParam(name = "stepId") String stepId)
					 throws Problem;
